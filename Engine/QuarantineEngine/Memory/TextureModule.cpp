...
void TextureModule::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels)
{
...
void TextureModule::createTextureImage(std::string path, BufferManageModule& managerModule, QueueModule& queueModule, CommandPoolModule& commandPoolModule)
{
    ...
    transitionImageLayout(image, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_IMAGE_ASPECT_COLOR_BIT);
