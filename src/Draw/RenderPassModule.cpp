...
RenderPassModule::RenderPassModule()
{
    ...
    this->ViewportRenderPass = std::make_shared<VkRenderPass>();
}
...
void RenderPassModule::CreateDirShadowRenderPass(VkFormat shadowFormat)
{
    ...
    // El shadow map se queda en READ_ONLY entre usos.
...
void RenderPassModule::CreateViewportRenderPass(VkFormat colorFormat, VkFormat depthFormat, VkSampleCountFlagBits msaaSamples)
{
    VkAttachmentDescription colorAttachment{};
    ...
    if (vkCreateRenderPass(device_ptr->device, &renderPassInfo, nullptr, ViewportRenderPass.get()) != VK_SUCCESS)
    {
