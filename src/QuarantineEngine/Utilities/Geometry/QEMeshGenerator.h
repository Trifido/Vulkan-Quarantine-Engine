...
namespace QE
{
    using ::IQEMeshGenerator;
    using ::CubeGenerator;
    using ::SphereGenerator;
    using ::PointGenerator;
    using ::TriangleGenerator;
    using ::QuadGenerator;
    using ::FloorGenerator;
    using ::GridGenerator;
    using ::CapsuleGenerator;
    using ::CylinderGenerator;
    using ::PyramidGenerator;
    using ::TorusGenerator;
    using ::ConeGenerator;
    using ::QEMeshGenerator;
} // namespace QE
