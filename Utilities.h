...
static void transitionImageLayout(VkDevice device, VkQueue queue, VkCommandPool commandPool, VkImage image, VkImageLayout oldImageLayout, VkImageLayout newImageLayout)
{
	// Create Buffer
